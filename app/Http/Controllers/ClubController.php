...
class ClubController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('clubs.index', compact('clubs', 'title'));
    }
    ...
    public function create()
    {
        ...
        return view('clubs.create', compact('title'));
    }
    ...
    public function show($id)
    {
        ...
        return view('clubs.delete', compact('title','club'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('clubs.edit', compact('title','club'));
    }
